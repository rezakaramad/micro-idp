...
import (
	...
	"github.com/rezakaramad/kubepave/src/controllers/tenant/internal/controller"
...
func init() {
	...
	utilruntime.Must(midpv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1be80449.rezakaramad.local",
